  ...
  return (
    <Layout user={user}>
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold font-primary text-emerald-950 mb-8 border-b border-zinc-200 pb-4">Privacy Policy</h1>
        ...
        <div className="space-y-8 font-secondary text-zinc-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">Collection</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">Usage</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">Sharing</h2>
