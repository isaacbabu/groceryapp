  ...
  return (
    <Layout user={user}>
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold font-primary text-emerald-950 mb-8 border-b border-zinc-200 pb-4">Terms & Conditions</h1>
        ...
        <div className="space-y-6 font-secondary text-zinc-700 leading-relaxed">
          ...
          <p className="font-bold text-zinc-900">ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</p>
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Thrissur and Kerala.</li>
